...
public class TicTacToeApplication {
    ...
    public static void main(String[] args) {
        ...
        while(doYouWantToPlay){
            // Set up our tokens and AI
            System.out.println("Welcome to Tic Tac Toe! You are about to play agianst"
                    + "rhe master of Tic Tac Toe. Are you ready?  I hope so!\n BUT FIRST, you"
                    +"must pick what character you want to be and what character you want me to be");
            System.out.println();
            System.out.println("Pick a single character that will represent you on the board");
            ...
            while (game.gameOver().equals("notOver")){
                if(game.currentMarker == game.userMarker){
                    ...
                    while(!game.playTurn(spot)){
                        System.out.println("Try agian."+spot+ "is valid. this spot is alredy taken"
           ...
           System.out.println("Do you want to play agian? Enter  Y if you do."
