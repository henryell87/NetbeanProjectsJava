      ...
      public void setNoun3(String newNoun3){
       ...
       randomNums = "not "+numberHolder[0]+" , not "+numberHolder[1]+ ", but"+ numberHolder[2];
        ...
        public void printInstructions(){
            System.out.println("Welcome to the MadLibs game. If you type in some words,"
        ...
        public void enterAdjective2(){
            System.out.println("I really need an alpace... just kidding. "
        ...
        public void putTogetherTheStory(){
            ...
            if(num == 0){
                  story = "Jessie and her best friend " +getName()+"went to Disney World today! "
                    ...
                    + "and then thhat night I gazed at the " +getRandomNums() + " "+
                    getAdjective2() + " fireworks shooting from the" + getNoun3() + ".";
            }else{
                story = "Amanda and her friend " +getName()+"went to the zoo las summer. "
